      ...
      <div className="constraint bg-[#0d0d0d] border-2 border-white flex gap-10 p-10 max-[1000px]:flex-col max-[512px]:p-6">
        <div className="flex-1 flex flex-col gap-5">
          <div className="flex flex-col gap-3">
            ...
            <p className="font-bold text-[36px] text-white leading-tight max-[512px]:text-[28px]">
              ONE REPOST FILLS
          ...
          <div className="flex gap-3">
            <button className="bg-primary text-black font-semibold px-8 py-5 cursor-pointer max-[512px]:flex-1 max-[512px]:px-4">
              Share on X
            </button>
            <button className="bg-black border border-[#a7ffc9] text-white font-semibold px-8 py-5 cursor-pointer max-[512px]:flex-1 max-[512px]:px-4">
              Copy Link
            </button>
          </div>
        </div>

        <div className="flex-1 bg-black border border-[#282828] p-8 max-[512px]:p-5 font-mono text-[16px] flex flex-col justify-center">
